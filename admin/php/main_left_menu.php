  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
       ...
       <li class="nav-item">
         <a href="pages/forms/subadmin_add.html" class="nav-link">
           <i class="nav-icon fas fa-pen"></i>
           <p>
             면접관등록
           </p>
       ...
       <li class="nav-item">
         <a href="pages/forms/subadmin_list.html" class="nav-link">
       ...
       <li class="nav-item">
        ...
        <li class="nav-item">
          <a href="pages/forms/inquire_list.html" class="nav-link">
        ...
        <li class="nav-item">
          <a href="pages/forms/employment_list.html" class="nav-link">
            <i class="nav-icon fas fa-book"></i>
            <p>
              문의리스트
            </p>
        ...
        <li class="nav-item">
          <a href="pages/forms/notice_add.html" class="nav-link">
            <i class="nav-icon fas fa-pen"></i>
            <p>
              공지등록
            </p>
        ...
        <li class="nav-item">
          <a href="pages/forms/notice_list.html" class="nav-link">
            <i class="nav-icon fas fa-book"></i>
            <p>
              공지리스트
            </p>
